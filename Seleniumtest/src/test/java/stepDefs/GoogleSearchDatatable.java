...
public class GoogleSearchDatatable {
	  ...
	  @When("I search for the following terms") public void
	  ...
	  @Then("I should see search results for each term") public void
	  i_should_see_search_results_for_each_term() {
